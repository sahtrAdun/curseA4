package dot.curse.matule.ui.screens.otpemail.comp
...
fun OtpEmailScreen(
    ...
    viewModel: OtpEmailViewModel = hiltViewModel(),
    ...
    Column(modifier = modifier
        ...
        Column(modifier = Adaptive()
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                Text(
                    text = stringResource(R.string.otpemail_title),
                ...
                Text(
                    text = stringResource(R.string.otpemail_text),
            ...
            MatuleTextField(
                ...
                actions = KeyboardActions(onDone = {
                    keyboard?.hide()
                    viewModel.apply {
                        navController.onButtonClick()
                    }
                })
            )
            MatuleButton(
                modifier = Adaptive().adaptiveElementWidthMedium().padding(top = 25.dp),
                text = stringResource(R.string.b_otpemail),
